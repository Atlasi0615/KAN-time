...
def main():
    ...
    cmds = [
        [py, "scripts/analyze_mlp_interpretability.py", "--run-dir", args.mlp_run_dir, "--config", args.config, "--split-type", args.split_type, "--device", args.device, *feature_args],
        [py, "scripts/analyze_kan_interpretability.py", "--run-dir", args.kan_run_dir, "--config", args.config, "--split-type", args.split_type, "--device", args.device, *feature_args],
